...
function FretboardMap() {
  ...
  const [currentInstrument, setCurrentInstrument] = useState(
    new MusicalInstrument(settings.instrument)
  );
  ...
  function createSequence(
    ...
    const newSequence = currentInstrument.generateSeqence(
      [keyNote, 4],
      MUSIC_CONST[seqType][seqName]
    );
      ...
      <div className="mobile-and-decktop-ui">
        <div className="mobile-ui">
          ...
          <SelectRootNoteMobile
            onNoteChange={(keyNote) =>
              createSequence(keyNote, sequenceType, sequenceName)
            }
            currentNoteName={rootNote}
          />
          <SelectSequenceTypeMobile
            onSequenceTypeChange={(sequenceType, sequenceName) =>
              createSequence(rootNote, sequenceType, sequenceName)
            }
        ...
        <div className="desktop-ui">
          <div className="ui-and-info">
            <div className="ui">
              ...
              />
              <SelectSequenceType
                onSequenceClick={(sequenceType, sequenceName) => {
              ...
              <SequencePanel
                ...
                currentSequence={sequenceName}
                onSequenceTypeClick={(sequenceName) =>
                  createSequence(rootNote, sequenceType, sequenceName)
                }
              />
            </div>
